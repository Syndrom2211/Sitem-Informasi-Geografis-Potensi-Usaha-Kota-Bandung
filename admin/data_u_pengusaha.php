  ...
  <body>
    ...
    if (isset($_POST["tambah_usaha"])) {
      ...
      if($cek){
        ...
        echo '<meta http-equiv="refresh" content="0; url=data_u_pengusaha.php"';
      }else{
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <form class="form-horizontal" action="data_u_pengusaha.php?aksi=tambah_data" method="POST" enctype="multipart/form-data">
                  <fieldset>
      ...
      <div class="container-fluid main-container">
          ...
          if(isset($_GET['aksi'])){
            ...
            <div class="col-md-10 content">
              <a href="data_u_pengusaha.php"><button style="margin-bottom:10px;" type="button" class="btn btn-primary"><< Kembali</button></a>
                <div class="panel panel-default">
                <div class="panel-heading">
                  <div class="row">
                    <div class="col col-xs-6">
                        <h5>Tambah Data Usaha Oleh Pengusaha</h5>
                      </div>
                ...
                <div class="panel-body">
                  <form class="form-horizontal" action="data_u_pengusaha.php" method="POST" enctype="multipart/form-data">
                  <fieldset>
                ...
                ?>
                <div class="col-md-10 content">
                  <a href="data_u_pengusaha.php?aksi=tambah_data"><button style="margin-bottom:10px;" type="button" class="btn btn-primary">Tambah</button></a>
            			  <div class="panel panel-default">
                    	<div class="panel-heading">
                    		<div class="row">
                          <div class="col col-xs-6">
                        ...
                        <table class="table table-list-search">
                          ...
                          <tbody id="myTable">
                            <?php
                            $i = 1;
                            foreach($admin_dinas->tampil_u_pengusaha() as $data){
                            ?>
                            <tr>
                              ...
                              <td>
                                ...
                                if($data["status_usaha"] == "T"){
                                  $statusnya = "<a href='data_u_pengusaha.php?aksi=ubah_statususaha_ya&id_usaha=".$data['id_usaha']."'><button class='btn btn-danger'>Tidak Aktif</button></a>";
                                }else if($data["status_usaha"] == "Y"){
                                  $statusnya = "<a href='data_u_pengusaha.php?aksi=ubah_statususaha_tidak&id_usaha=".$data['id_usaha']."'><button class='btn btn-success'>Aktif</button></a>";
                                }
                                echo $statusnya;
                                ?>
                              </td>
                              <td>
                                ...
                                <a href="data_u_pengusaha.php?aksi=ubah_data&id_usaha=<?php echo $data['id_usaha']; ?>"><button style="margin-bottom:10px;" type="button" class="btn btn-success">Edit</button></a>
                                <a href="data_u_pengusaha.php?aksi=hapus_data&id_usaha=<?php echo $data['id_usaha']; ?>"><button style="margin-bottom:10px;" type="button" class="btn btn-danger">Hapus</button></a>
                              </td>
                            </tr>
