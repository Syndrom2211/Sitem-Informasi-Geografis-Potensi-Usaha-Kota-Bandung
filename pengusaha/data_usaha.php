  ...
  <body>
    ...
    if (isset($_POST["tambah_usaha"])) {
      ...
      if($cek){
        ...
        echo '<meta http-equiv="refresh" content="0; url=data_usaha.php"';
      }else{
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <form class="form-horizontal" action="data_usaha.php?aksi=tambah_data" method="POST" enctype="multipart/form-data">
                  <fieldset>
          ...
          if(isset($_GET['aksi'])){
            if ($_GET['aksi'] == 'tambah_data') {
              if($_SESSION["status_akun"] == "T"){
                echo "<script>alert('Status akun belum diaktifasi, cek inbox email untuk memastikan');</script>";
                echo '<meta http-equiv="refresh" content="0; url=data_usaha.php">';
              }else{
            ?>
            <div class="col-md-10 content">
              <a href="data_usaha.php"><button style="margin-bottom:10px;" type="button" class="btn btn-primary"><< Kembali</button></a>
                <div class="panel panel-default">
                <div class="panel-heading">
                  <div class="row">
                    <div class="col col-xs-6">
                        <h5>Tambah Data Usaha</h5>
                      </div>
                ...
                <div class="panel-body">
                  <form class="form-horizontal" action="data_usaha.php" method="POST" enctype="multipart/form-data">
                  <fieldset>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-5">
                    <input id="Pemilik Usaha" type="text" class="form-control input-md" value="<?php echo $_SESSION['nama_pengusaha']; ?>" readonly>
                    <input name="pemilik" type="hidden" class="form-control input-md" value="<?php echo $_SESSION['no_ktp']; ?>" readonly>
                    </div>
                  </div>
                  ...
                  <div class="panel-body">
                    ...
                    <div class="form-group">
                      ...
                      <script type="text/javascript">
                        function initAutocomplete() {
                          var map = new google.maps.Map(document.getElementById('map'), {
                            center: {lat: <?php echo $databy['latitude_lokasi']; ?>, lng: <?php echo $databy['longitude_lokasi']; ?>},
                            zoom: 13,
                            mapTypeId: 'roadmap'
                          });
                ...
                ?>
                <div class="col-md-10 content">
                  <a href="data_usaha.php?aksi=tambah_data"><button style="margin-bottom:10px;" type="button" class="btn btn-primary">Tambah</button></a>
            			  <div class="panel panel-default">
                    	<div class="panel-heading">
                    		<div class="row">
                          <div class="col col-xs-6">
                        ...
                        <table class="table table-list-search">
                          ...
                          <tbody id="myTable">
                            ...
                            foreach($pemilik_usaha->tampil_usaha($no_ktp) as $data){
                            ?>
                            <tr>
                              ...
                              <td>
                                ...
                                if($data["status_usaha"] == "T"){
                                  ...
                                  echo "<font color='lime'>Aktif</font>";
                                }
                                ?>
                              </td>
                              <td>
                                ...
                                <a href="data_usaha.php?aksi=ubah_data&id_usaha=<?php echo $data['id_usaha']; ?>"><button style="margin-bottom:10px;" type="button" class="btn btn-success">Edit</button></a>
                              </td>
                            </tr>
